...
>
> | Сборка / ветка | Хост | Образ ОС |
> |----------------|------|----------|
> | базовая (`main`), `stealthchanger` | BTT **CB2** в Manta M8P | **BTT CB2 V3.0.2** (Debian 12, kernel 6.1) — [bigtreetech/CB2 V3.0.2](https://github.com/bigtreetech/CB2/releases/tag/V3.0.2) |
> | `fly-d8`, `mks-monster8` | **Raspberry Pi 4B** | **MainsailOS 3.0** — [docs.mainsail.xyz](https://docs.mainsail.xyz/setup/mainsail-os) |
>
...
- В сборках `fly-d8` / `mks-monster8` роль хоста выполняет **Raspberry Pi 4B** с **MainsailOS 3.0** (вместо CB2).
